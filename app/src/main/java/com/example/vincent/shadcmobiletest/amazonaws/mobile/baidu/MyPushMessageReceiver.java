package com.example.vincent.shadcmobiletest.amazonaws.mobile.baidu;
...
import com.example.vincent.shadcmobiletest.amazonaws.mobile.activity.NotificationActivity;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            AwsApplication.Companion.getPinpointManager().getNotificationClient().registerDeviceToken(userId, channelId);
        }
    ...
    public void onMessage(Context context, String message,
        ...
        if (!TextUtils.isEmpty(customContentString)) {
            ...
            try {
                ...
                NotificationDetails notificationDetail = NotificationDetails.builder()
                        .message(customJson.toString())
                        .intentAction(NotificationClient.BAIDU_INTENT_ACTION)
                        .build();

                NotificationClient.CampaignPushResult pushResult = AwsApplication.Companion.getPinpointManager()
                        .getNotificationClient().handleCampaignPush(notificationDetail);
...
//                        data !!.
//                        putString("message", String.format("Received Campaign Push:\n%s", data.toString()))
//                        broadcast(from, data)
                    }
                    return;
                }
